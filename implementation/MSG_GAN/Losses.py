...
class WGAN_GP(GANLoss):
    ...
    def __gradient_penalty(self, real_samps, fake_samps,
        ...
        # forward pass
        op = self.dis.forward(merged, alpha)
    ...
    def dis_loss(self, real_samps, fake_samps, alpha=0.85):
        ...
        if self.use_gp:
            ...
            gp = self.__gradient_penalty(real_samps, fake_samps, alpha)
            loss += gp

        return loss

    def gen_loss(self, _, fake_samps, alpha=0.85):
